...
YAHOO.env = YAHOO.env || {
        modules: [], listeners: [], getVersion: function (name) {
...
(function () {
    ...
    var ua = navigator.userAgent.toLowerCase(), isOpera = (ua.indexOf('opera') > -1),
        isSafari = (ua.indexOf('safari') > -1), isGecko = (!isOpera && !isSafari && ua.indexOf('gecko') > -1),
...
(function () {
    var Dom = YAHOO.util.Dom, AttributeProvider = YAHOO.util.AttributeProvider;
    ...
    YAHOO.util.Element.prototype = {
        DOM_EVENTS: null, appendChild: function (child) {
...
(function () {
    ...
    YAHOO.extend(TB.widget.ScrollSlide, TB.widget.Slide, {
        initSlides: function () {
            ...
            var args = {scroll: {by: [0, this.slidesUL.offsetHeight * (n - this.curSlide)]}};
