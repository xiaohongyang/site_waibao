...
!(function(){
    ...
    $.x_say = function(option){
        ...
        var setDom = function(){
            ...
            closeBtn = $("<span class='x_say_close_btn btn btn-xs btn-primary'></span>");
            ...
            var container = opt.container ? opt.container : $('body')
...
!(function($){
    ...
    $.fn.x_popup = function(opt){
        ...
        var setStyle = function(){
            ...
            var container = option.container ? option.constructor : $('body')
            container.append(winWrapper);
